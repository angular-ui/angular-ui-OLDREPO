...
*  Can also take in an event url as a source object and feed the events per view. 
*
*/
...
angular.module('ui.directives').directive('uiCalendar',['ui.config', '$parse', function (uiConfig,$parse) {
    ...
    return {
        ...
        link: function(scope, elm, $attrs) {
            ...
            //on load update call.
            update();
            //watching the length of the array to create a more effifient process. 
